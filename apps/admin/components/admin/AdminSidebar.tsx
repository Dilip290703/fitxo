...
const NAV_ITEMS = [
  ...
  { href: '/admin/live-map', label: 'Live Map', icon: '🗺️' },
  { href: '/admin/notifications', label: 'Notifications', icon: '🔔' },
  { href: '/admin/payouts', label: 'Store Payouts', icon: '💰' },
  { href: '/admin/agent-payouts', label: 'Agent Payouts', icon: '🛵' },
  { href: '/admin/complaints', label: 'Complaints', icon: '🎧' },
  { href: '/admin/analytics', label: 'Analytics', icon: '📊' },
  { href: '/admin/try-analytics', label: 'Try & Returns', icon: '👕' },
