...
export default function NewStorePage() {
  ...
  return (
    <div className="max-w-2xl">
      <h2 className="text-xl font-bold text-ink mb-6">Add New Store</h2>
      <form onSubmit={handleSubmit} className="bg-white border border-line rounded-xl p-6 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-2">
            <label className="block text-xs font-medium text-soft mb-1.5">Store Name *</label>
        ...
        <div className="flex justify-end gap-3 pt-2">
          <button type="button" onClick={() => router.back()} className="px-4 py-2 text-sm border border-line-strong text-body rounded-lg hover:border-line-strong">
            Cancel
          </button>
          <button type="submit" disabled={saving} className="px-6 py-2 text-sm bg-ink hover:bg-ink-soft disabled:opacity-60 text-white font-semibold rounded-lg">
