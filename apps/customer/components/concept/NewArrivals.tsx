    ...
    <section className="bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-[1400px] px-5 lg:px-8">
        <CxReveal className="text-center">
          <p className="text-[13px] font-semibold uppercase tracking-[0.28em] text-[#b0703f]">Premium Active</p>
        ...
        <CxRevealGroup className="mt-12 grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4">
          {tiles.map((p, i) => (
